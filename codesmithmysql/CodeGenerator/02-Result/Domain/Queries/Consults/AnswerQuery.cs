...
namespace Sand.Domain.Queries.Consults {
    ...
    /// 答案表查询实体
    /// </summary>
    public class AnswerQuery :  BaseQuery<Answer> {
        ...
        private string _optionsId = string.Empty;
        /// <summary>
        /// 选项值
        /// </summary>
        [Display(Name="选项值")]
        public string OptionsId {
            get { return _optionsId == null ? string.Empty : _optionsId.Trim(); }
        ...
        public string Suggestion {
            get { return _suggestion == null ? string.Empty : _suggestion.Trim(); }
