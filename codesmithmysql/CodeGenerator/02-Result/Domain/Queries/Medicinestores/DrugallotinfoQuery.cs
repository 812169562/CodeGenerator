...
namespace Sand.Domain.Queries.Medicinestores {
    ...
    /// 调拨明细表查询实体
    /// </summary>
    public class DrugallotinfoQuery :  BaseQuery<Drugallotinfo> {
        ...
        private string _drugAllotId = string.Empty;
        /// <summary>
        /// 调拨编号
        /// </summary>
        [Display(Name="调拨编号")]
        public string DrugAllotId {
            get { return _drugAllotId == null ? string.Empty : _drugAllotId.Trim(); }
            set{ _drugAllotId=value;}
        }        
