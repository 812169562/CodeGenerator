...
<div>
 ...
 <el-table ref="multipleTable"  column-key="id" tooltip-effect="dark" style="width: 100%" max-height="780" :height="fullHeight" size="small" :data="drugsData"  @selection-change="handleSelectionChange">
 ...
 <el-table-column type="index"  fixed="left" label="序号"    width="55"></el-table-column>
         ...
         <el-table-column prop="type" label="（如：成药,精麻,等等）" width="100"></el-table-column>
         ...
         <el-table-column prop="drugTypeId" label="药品分类" width="100"></el-table-column>
         <el-table-column prop="drugType" label="药品分类" width="100"></el-table-column>
         <el-table-column prop="drugTypeRelationShip" label="药品分类类型" width="100"></el-table-column>
         <el-table-column prop="englishName" label="英文名" width="100"></el-table-column>
         <el-table-column prop="storeroomUnitId" label="库房单位" width="100"></el-table-column>
         <el-table-column prop="storeroomUnit" label="库房单位" width="100"></el-table-column>
         <el-table-column prop="useUnitId" label="使用单位" width="100"></el-table-column>
         <el-table-column prop="useUnit" label="使用单位" width="100"></el-table-column>
         ...
         <el-table-column prop="basicUnitId" label="基本单位" width="100"></el-table-column>
         <el-table-column prop="basicUnit" label="基本单位" width="100"></el-table-column>
         <el-table-column prop="isActualInventory" label="是否按照实际库存卖" width="100"></el-table-column>
         <el-table-column prop="storeroomRatio" label="库房比例" width="100"></el-table-column>
         <el-table-column prop="salesRatio" label="销售比例" width="100"></el-table-column>
         <el-table-column prop="commonDose" label="常用剂量" width="100"></el-table-column>
         <el-table-column prop="chlidCommonDose" label="儿童常用剂量" width="100"></el-table-column>
         ...
         <el-table-column prop="lowerLimit" label="下限提醒" width="100"></el-table-column>
         <el-table-column prop="isPrescription" label="是否为处方药品" width="100"></el-table-column>
         <el-table-column prop="drugCommCode" label=" 药品通用码（869）" width="100"></el-table-column>
         <el-table-column prop="remarks" label="备注" width="100"></el-table-column>
         <el-table-column prop="usePath" label="使用说明书地址" width="100"></el-table-column>
         <el-table-column prop="img" label="药品图片" width="100"></el-table-column>
         <el-table-column prop="dddFomat" label="DDD规格" width="100"></el-table-column>
         <el-table-column prop="dddValue" label="DDD值" width="100"></el-table-column>
 ...
 <drugs-edit :dialogVisible="dialog" @closeAdd="_addClose" :id="childId"></drugs-edit>
</div>
</template>
<script>
import DrugsEdit from './edit'
export default {
  /** 页面绑定数据 */
  data() {
    return {
  ...
  methods: {
    ...
    query() {
      ...
      this.$request.get(
        ...
        respose => {
          _this.drugsData = respose.data.result
     ...
     */
    del(row) {
      const drugs = this.selectdata(row)
      if (!drugs || drugs.length === 0) {
        this.$message.error('请选择一条数据！')
        return
      }
      this.$request.delete('drugs', { drugs }, respose => {
        this.query()
      })
    },
    /**  编辑选中数据  @for Drugs
    ...
    stop(row, isEnable) {
      ...
      if (drugs.find(t => t.isEnable === isEnable)) {
    ...
    /** 回调-子窗口添加完成之后回调关闭刷新当前页面   @for Drugs
     * @param 当前选中行
     */
