...
<div>
 ...
 <el-table ref="multipleTable"  column-key="id" tooltip-effect="dark" style="width: 100%" max-height="780" :height="fullHeight" size="small" :data="couponData"  @selection-change="handleSelectionChange">
 ...
 <el-table-column type="index"  fixed="left" label="序号"    width="55"></el-table-column>
         ...
         <el-table-column prop="activityId" label="优惠活动编号" width="100"></el-table-column>
         <el-table-column prop="imgPath" label="图片地址" width="100"></el-table-column>
         <el-table-column prop="name" label="活动内容" width="100"></el-table-column>
         <el-table-column prop="type" label="类型" width="100"></el-table-column>
         <el-table-column prop="level" label="等级" width="100"></el-table-column>
         <el-table-column prop="code" label="活动编号" width="100"></el-table-column>
         <el-table-column prop="stock" label="库存" width="100"></el-table-column>
         <el-table-column prop="useLine" label="使用上限" width="100"></el-table-column>
         <el-table-column prop="allowableSuperposition" label="是否允许和其他优惠卷进行叠加" width="100"></el-table-column>
         <el-table-column prop="startTime" label="开始时间" width="180"></el-table-column>
         <el-table-column prop="endTime" label="结束时间" width="180"></el-table-column>
         <el-table-column prop="sort" label="排序" width="100"></el-table-column>
         <el-table-column prop="instructions" label="" width="100"></el-table-column>
 ...
 <coupon-edit :dialogVisible="dialog" @closeAdd="_addClose" :id="childId"></coupon-edit>
</div>
</template>
<script>
  ...
  methods: {
    ...
    query() {
      ...
      this.$request.get(
        ...
        respose => {
          _this.couponData = respose.data.result
     ...
     */
    del(row) {
      const coupon = this.selectdata(row)
      if (!coupon || coupon.length === 0) {
        this.$message.error('请选择一条数据！')
        return
      }
      this.$request.delete('coupon', { coupon }, respose => {
        this.query()
      })
    },
    /**  编辑选中数据  @for Coupon
    ...
    stop(row, isEnable) {
      ...
      if (coupon.find(t => t.isEnable === isEnable)) {
    ...
    /** 回调-子窗口添加完成之后回调关闭刷新当前页面   @for Coupon
     * @param 当前选中行
     */
