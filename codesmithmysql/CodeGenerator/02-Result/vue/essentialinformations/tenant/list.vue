...
<div>
 ...
 <el-table-column type="index"  fixed="left" label="序号"    width="55"></el-table-column>
         <el-table-column prop="tenantName" label="医馆名" width="100"></el-table-column>
         <el-table-column prop="userId" label="用户号" width="100"></el-table-column>
         ...
         <el-table-column prop="maxStore" label="最大门店数量" width="100"></el-table-column>
         ...
         <el-table-column prop="description" label="简介" width="100"></el-table-column>
...
export default {
  ...
  methods: {
     ...
     */
    del(row) {
      const tenant = this.selectdata(row)
